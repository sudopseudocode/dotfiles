    ...
    require("goose").setup({
      keymap = {
        global = {
          ...
          diff = {
            open = "<leader>ad", -- Opens a diff tab of a modified file since the last goose prompt
            next = "<leader>a]", -- Navigate to next file diff
            prev = "<leader>a[", -- Navigate to previous file diff
            close = "<leader>ac", -- Close diff view tab and return to normal editing
            revert_all = "<leader>ara", -- Revert all file changes since the last goose prompt
            revert_this = "<leader>art", -- Revert current file changes since the last goose prompt
          },
        },
        window = {
